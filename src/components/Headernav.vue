<template>
    <header class="fixed-top bg-white m-0 border-bottom border-2">
        <nav class="container position-relative">
            <!-- 電腦版導航 (lg 以上) -->
            <div
                class="d-none d-lg-flex flex-wrap align-items-center justify-content-between py-2 m-0"
            >
                <!-- Logo (可依專案結構自行調整 src 路徑) -->
                <router-link
                    to="/"
                    class="d-flex align-items-center mb-0 text-dark text-decoration-none"
                >
                    <img
            ...
            <!-- 移動版導航 (lg 以下) -->
            <div
                class="d-flex d-lg-none flex-wrap align-items-center justify-content-between py-2 m-0"
            >
                <router-link
                    to="/"
                    class="d-flex align-items-center mb-0 text-dark text-decoration-none"
                ...
                <button
                    ...
                    data-bs-target="#collapseNavHeader"
                    aria-controls="collapseNavHeader"
                    aria-expanded="false"
                >
